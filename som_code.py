...
class MiniSom(object):
    ...
    def winner(self, x):
        ...
        '''
        print('active map-------------------------')
        print(self._activation_map)
        print('end----------------------------------')
        print('min:{0}, shape{1}'.format(self._activation_map.argmin(), self._activation_map.shape))
        '''
        ind = unravel_index(self._activation_map.argmin(), self._activation_map.shape)
        # print('index:' + str(ind))
    ...
    def train(self, data, num_iteration, random_order=False, verbose=False):
        ...
        for t, iteration in enumerate(iterations):
            ...
            print('end-----------------------------------')
            '''
            winners = self.winner(data[iteration])
            '''
            print('winner-------------------------------')
            print(winners)
            print('end-----------------------------------')
            '''
            self.update(data[iteration], winners, t, num_iteration)
        if verbose:
